...
tests = test [
  "parse a solitary entry" ~: do
      ...
      assertParsesTo (entry R.epoch) input
        (R.entry (I.instant I.epoch 14 30) ["entry"])
  ,
  ...
  "parse multi-element entry" ~: do
      ...
      assertParsesTo (entry R.epoch) input
        (R.entry (I.instant I.epoch 14 30) ["field1", "field2", "field3"])
  ,
  ...
  "requires leading whitespace for entry" ~: do
      ...
      assertParsesTo (entry R.epoch) input
        (R.entry (I.instant I.epoch 14 30) ["field1", "field2"])
  ,
  ...
  "entry with combinator" ~: do
      let input = unlines [
            "  14:30 field1",
            "  15:30 field2"]
      assertParsesTo (many (entry R.epoch)) input
        [(R.entry (I.instant I.epoch 14 30) ["field1"]),
         (R.entry (I.instant I.epoch 15 30) ["field2"])]
  ,
  ...
  "record parsing returns a Record" ~: do
      ...
      assertParsesTo diary input [R.onDate 7 7 2008]
  ,
  ...
  "parse date and time with description" ~: do
      ...
      assertParsesTo diary input [R.push e (R.onDate 7 7 2008)]
  ,
  ...
  "parse multiple records" ~: do
      ...
      case runParser diary () input input of
        ...
        (Right actual) -> assertEqual "Multiple records"
          [(R.push e1 $ R.onDate 7 7 2008),
           (R.push e2 $ R.onDate 7 7 2008)]
          actual
  ]
\end{code}
